...
COMMON_DEP="dev-java/wadi-group
			dev-java/jetty-servlet-api
			dev-java/cglib
...
EANT_GENTOO_CLASSPATH="wadi-group jetty-servlet-api cglib-2.1 commons-logging commons-httpclient-3"
