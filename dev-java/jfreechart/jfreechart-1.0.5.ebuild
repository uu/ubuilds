...
# $Header: /var/cvsroot/gentoo-x86/dev-java/jfreechart/jfreechart-1.0.4.ebuild,v 1.1 2009/02/09 23:51:12 fordfrog Exp $
...
IUSE="test"
COMMON_DEPEND="
	>=dev-java/itext-2.0.1
	>=dev-java/jcommon-1.0.9
...
src_test() {
	...
	LC_ALL="C" ANT_TASKS="ant-junit" ANT_OPTS="-Djava.awt.headless=true -Duser.timezone=UTC" eant -f ant/build.xml test $(get_jars)
}
