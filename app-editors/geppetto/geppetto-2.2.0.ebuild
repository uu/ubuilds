...
SRC_URI="x86?   ( https://github.com/downloads/cloudsmith/geppetto/geppetto-linux.gtk.x86-${PV}-R201205011340.zip )
	 amd64? ( https://github.com/downloads/cloudsmith/geppetto/geppetto-linux.gtk.x86_64-${PV}-R201205011340.zip )"
