...
MY_PV="v${PV}-ee"
MY_GIT_COMMIT="047fcee246026ea5f4425b26fa8cfd1639049f94"

GITALY_VERSION="0.38.0"
GITLAB_PAGES_VERSION="0.5.1"
GITLAB_SHELL_VERSION="5.9.0"
GITLAB_WORKHORSE_VERSION="3.0.0"
# https://gitlab.com/gitlab-org/gitlab-ee/repository/v10.0.4-ee/archive.tar.gz
DESCRIPTION="GitLab is a free project and repository management application"
HOMEPAGE="https://about.gitlab.com/"
#SRC_URI="https://gitlab.com/gitlab-org/${PN}/repository/archive.tar.gz?ref=${MY_PV} -> ${P}.tar.gz"
SRC_URI="https://gitlab.com/gitlab-org/${PN}/repository/v${PV}-ee/archive.tar.gz -> ${P}.tar.gz"
