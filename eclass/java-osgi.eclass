...
# -----------------------------------------------------------------------------
# @ebuild-function java-osgi_makejar
#
# @example
#	java-osgi_makejar "dist/${PN}.jar" "com.jcraft.jsch" "JSch" "com.jcraft.jsch, com.jcraft.jsch.jce;x-internal:=true" 
#
...
java-osgi_makejar() {
	...
	(( ${#} < 4 )) && die "Four arguments are needed for java-osgi_makejar()"
...
# -----------------------------------------------------------------------------
# @ebuild-function java-osgi_makejar-fromfile
#
# @example
#	java-osgi_makejar-fromfile "dist/${PN}.jar" "${FILESDIR}/MANIFEST.MF" "JSch" 1
#
# @param $1 - name of jar to repackage with OSGi
...
java-osgi_makejar-fromfile() {
	debug-print-function ${FUNCNAME} "$@"

	((${#} < 4)) && die "Four arguments are needed for java-osgi_makejar-fromfile()"
