...
EANT_GENTOO_CLASSPATH="commons-daemon,tomcat-servlet-api-2.5,eclipse-ecj-3.3"
...
-Dcompile.debug=false -Dcommons-daemon.jar=commons-daemon.jar
-Djsp-api.jar=jsp-api.jar -Dservlet-api.jar=servlet-api.jar -Dant.jar=ant.jar"
