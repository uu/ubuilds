...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/munin/munin-2.0_rc5.ebuild,v 1.1 2012/04/18 16:42:16 darkside Exp $
...
ESVN_REPO_URI="svn://munin-monitoring.org/munin/trunk"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.0-Makefile.patch
