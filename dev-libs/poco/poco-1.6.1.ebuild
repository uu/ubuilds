...
SRC_URI="http://pocoproject.org/releases/poco-$(get_version_component_range 1-3)/${P}-all.tar.bz2
...
epatch \
		...
		"${FILESDIR}"/1.6.1-pcre.patch \
		"${FILESDIR}"/1.6.1-pcre2.patch \
		"${FILESDIR}"/1.6.1-gentoo.patch 
}
